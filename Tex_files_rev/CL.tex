...
\end{equation}
\bb{Due to the proportionality between $\kappa_0$ and $M_{200}$ in Eq.~\ref{eq:tracer}, we constrain the quanity $\frac{\hat{\kappa}_0}{\sigma_{\kappa_0}}$ in order to get the mass contraint, $\frac{\hat{M}_{200}}{\sigma_{M_{200}}}$. For estimating inverse variance,} we often use the curved-sky expression
...
We now consider 1000 simulations with a cluster mass of $M_{200} = 2 \times 10^{14} M_{\odot}$ and $z=0.7$, closer to the expected mean values of the CMB-S4 clusters. \bb{\st{We reconstruct the lensing signal with scales between  $\ell_{\text{min}}^{\, \text{CMB}}=100$ and $\ell_{\text{max}}^{\, \text{CMB}} = 4000$, for both polarization and temperature maps.}}
