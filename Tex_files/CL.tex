...
We now consider a cluster of mass of $M_{200} = 2\times 10^{14}$, at $z=0.7$, which should reflect the mean mass of future CMB surveys \LL{to check}. As previously, we consider a CMB-S4 noise configuration.
