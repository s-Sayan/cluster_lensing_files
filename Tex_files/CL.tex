...
\begin{figure}[H]
  ...
  % \includegraphics[width=0.7\hsize]{Figures/template_func_theta_.png}}
   ...
   \caption{This figure shows the well-known dipole-like structure that we expect in (lensed-unlensed)~\protect\footnotemark[1] sky when there is a cluster with $M_{200} = 2\times 10^{14} M_{\odot}$\protect\footnotemark[2], $z=0.7$ present in our line of sight.}
   \label{fig:dipole} 
\end{figure} 
